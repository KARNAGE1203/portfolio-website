...
export default function LearningZone() {
  return (
    <ProjectPage
      ...
      heroImage="/img/LearningZone Redesign Screenshots/TopImage.webp"
      ...
      wireframes={[
        {
          label: 'Dashboard',
          lofi: '/img/LearningZone Redesign Screenshots/Dashboard_Lofi.webp',
          hifi: '/img/LearningZone Redesign Screenshots/Dashboard Page.png',
        },
        {
          label: 'Home',
          lofi: '/img/LearningZone Redesign Screenshots/Home_Lofi.webp',
          hifi: '/img/LearningZone Redesign Screenshots/Home Page.png',
        },
        {
          label: 'Course Info',
          lofi: '/img/LearningZone Redesign Screenshots/Course Info_Lofi.webp',
